insecure-warning = **Disabled due to insecure context.**
noscript-warning = **WARNING:** You have disabled JavaScript. Secure context integrity checks are disabled.

optional-placeholder = (optional)
advanced-placeholder = (optional, advanced use only)
error = Error:

error-internal = An error occurred, please try again later or contact the site administrator.
...
add-feed-error-invalid-credentials = There was a problem getting your account data, please try again.
